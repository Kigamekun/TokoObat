...
const MedicineCatalog = () => {
  ...
  const [medicines, setMedicines] = useState([
    ...
    },
    {
      ...
      description: 'Expired medicine for demo',
      status: 'expired',
      ...
      <Card className="p-4 hover:shadow-lg transition-all duration-200">
        ...
        <div className="space-y-2 text-sm">
          <div className="flex justify-between">
            ...
            <span className="font-semibold text-teal-600">{formatCurrency(medicine.price)}</span>
          </div>
          <div className="flex justify-between">
          ...
          <div className="flex justify-between">
            ...
            <span className="text-gray-900">{new Date(medicine.expirationDate).toLocaleDateString('id-ID')}</span>
          </div>
        </div>
   ...
   <DashboardLayout>
     <div className="space-y-6 fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900" data-testid="medicine-catalog-title">Medicine Catalog</h1>
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select value={newMedicine.unit} onValueChange={(value) => setNewMedicine({ ...newMedicine, unit: value })}>
